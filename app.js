...
function openPriorityModal(priority, deals) {
    ...
    projectGroups.forEach((projectDeals, projectName) => {
        ...
        // CARI TAHAP TERBARU (berdasarkan updatedAt)
        ...
        // CARI TANGGAL DIBUAT TERLAMA (createdAt)
        ...
        // AMBIL DEAL PERTAMA SEBAGAI REFERENSI UNTUK ID DAN DATA LAIN
        ...
        const mergedDeal = {
            ...
            priority: priority,
            // SALES: gunakan salesDisplay (SEMUA SALES)
            salesName: salesDisplay,
            salesList: uniqueSalesList,
            hasMultipleSales: hasMultipleSales,
            // NILAI: gunakan maxValue (NILAI TERTINGGI)
            value: maxValue,
            displayValue: maxValue,
            // TAHAP: gunakan dari deal terbaru
            stage: latestDeal.stage || firstDeal.stage,
            // TANGGAL DIBUAT: gunakan dari deal terlama
            createdAt: oldestDeal.createdAt || firstDeal.createdAt,
            // TANGGAL UPDATE: gunakan dari deal terbaru
            updatedAt: latestDeal.updatedAt || firstDeal.updatedAt,
            // INDIKATOR
            totalDealsInGroup: projectDeals.length,
            projectDeals: projectDeals,
            // DATA LAIN DARI DEAL PERTAMA
            consultant: firstDeal.consultant,
            contractor: firstDeal.contractor,
            facility: firstDeal.facility,
            package: firstDeal.package,
            product: firstDeal.product,
            owner: firstDeal.owner,
            pic: firstDeal.pic,
            planPO: firstDeal.planPO,
            remarks: firstDeal.remarks,
            beforeDiscount: firstDeal.beforeDiscount,
            discount: firstDeal.discount,
            createdBy: firstDeal.createdBy,
            updatedBy: firstDeal.updatedBy
        };
