                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3"> <!-- Changed lg:grid-cols-3 to lg:grid-cols-4 -->
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="contractor" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition duration-150 text-sm">
                                    <option value="">Pilih Kontraktor</option>
                                </select>
                                <input type="text" id="newContractor" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition duration-150 text-sm mt-2" placeholder="Atau ketik nama kontraktor baru">
                            </div>
                            <div class="mb-3">
    ...
    <script>
            ...
            query.get()
                .then((querySnapshot) => {
                    ...
                    querySnapshot.forEach((doc) => {
                        ...
                        if (dealData.contractor) uniqueContractors.add(dealData.contractor);
                    ...
                    renderAllDeals(); // Panggil renderAllDeals setelah deals dimuat
                })
                .catch((error) => {
        ...
        function renderAllDeals() {
            ...
            if (currentUserRole === 'admin') {
                ...
                // User sales tidak melihat deal apapun secara default di tampilan utama
                pipelineStage.innerHTML = `
                    <div class="empty-stage-message text-center text-gray-400 p-4 text-sm w-full">
                        <i class="fas fa-inbox text-3xl mb-2"></i>
            ...
            initSortable(); // Inisialisasi ulang SortableJS setelah DOM diperbarui
        }
        ...
        function openDealModal(dealId = null) {
            ...
            // Isi dropdown Konsultan, Kontraktor, PIC, Owner
            populateDropdown('consultant', uniqueConsultants);
            populateDropdown('contractor', uniqueContractors);
            ...
            if (dealId) {
                ...
                if (deal) {
                    ...
                    // Set nilai untuk dropdown Kontraktor
                    if (deal.contractor && uniqueContractors.has(deal.contractor)) {
                        document.getElementById('contractor').value = deal.contractor;
                    } else {
                        document.getElementById('contractor').value = '';
                        document.getElementById('newContractor').value = deal.contractor || '';
                    }
        ...
        async function saveDeal() {
            ...
            // Ambil nilai kontraktor dari input teks baru jika ada, jika tidak, ambil dari dropdown
            let contractor = document.getElementById('newContractor').value.trim();
            if (!contractor) {
        ...
        function openDealDetailModal(dealId) {
            ...
            document.getElementById('detailContractor').textContent = deal.contractor || '-';
        ...
        function initEventListeners() {
            ...
            try {
                ...
                // or resetFilters().
                // However, if you want real-time filtering as user changes dropdowns inside the panel,
        ...
        // Fungsi ini sekarang akan mencari di SEMUA deals yang dimuat ke variabel 'deals'
        function filterDeals() {
            try {
                ...
                const salesFilter = document.getElementById('filterSales').value; // Tambahkan ini
                ...
                // Jika semua filter kosong, kembalikan ke tampilan default
                if (searchTerm === '' && priorityFilter === 'all' && yearFilter === 'all' && stageFilter === 'all' && salesFilter === 'all' && // Tambahkan salesFilter
                ...
                const filteredDeals = deals.filter(deal => {
                    ...
                    const matchesSales = salesFilter === 'all' || 
                                         (deal.salesName && deal.salesName === salesFilter); // Tambahkan ini
                    ...
                    const matchesContractor = contractorFilter === 'all' || 
                                              (deal.contractor && deal.contractor === contractorFilter);
                    ...
                    return matchesSearch && matchesPriority && matchesYear && matchesStage && matchesSales && // Tambahkan matchesSales
